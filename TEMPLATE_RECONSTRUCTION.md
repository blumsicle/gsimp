...
This document describes the starter project generated by `bcli create` closely enough that a fresh Codex session could rebuild a very similar project from scratch in an empty directory.

It documents the generated scaffold, not the `bcli` generator implementation.
